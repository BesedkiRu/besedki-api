...
export class init1686492020845 implements MigrationInterface {
    name = 'init1686492020845'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."pavilion_type_enum" AS ENUM('house', 'pavilion')`);
        await queryRunner.query(`CREATE TABLE "pavilion" ("id" SERIAL NOT NULL, "name" text NOT NULL, "coords" numeric array NOT NULL, "square" numeric NOT NULL, "type" "public"."pavilion_type_enum" NOT NULL DEFAULT 'pavilion', "capacity" integer NOT NULL, "bedrooms" integer NOT NULL, "price" numeric NOT NULL, "main_img" text, "images" text array NOT NULL DEFAULT '{}', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "pavilion_map_id" integer NOT NULL, CONSTRAINT "PK_f29004933b6302eb9eafba7692d" PRIMARY KEY ("id", "pavilion_map_id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "pavilion_pkey" ON "pavilion" ("id") `);
        await queryRunner.query(`CREATE TYPE "public"."user_role_enum" AS ENUM('admin', 'client', 'owner', 'employee')`);
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "name" text NOT NULL, "surname" text NOT NULL, "email" text NOT NULL, "password" text NOT NULL, "role" "public"."user_role_enum" NOT NULL DEFAULT 'client', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "organization_id" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "user_pkey" ON "user" ("id") `);
        await queryRunner.query(`CREATE TABLE "organization" ("id" SERIAL NOT NULL, "name" text NOT NULL, "director_full_name" text NOT NULL, "email" text NOT NULL, "phone" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_472c1f99a32def1b0abb219cd67" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "organization_pkey" ON "organization" ("id") `);
        await queryRunner.query(`CREATE TABLE "pavilion_map" ("id" SERIAL NOT NULL, "name" text NOT NULL, "coords" numeric array NOT NULL, "address" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "organization_id" integer NOT NULL, CONSTRAINT "PK_ee49c6ce278d0d61486d3a1aa83" PRIMARY KEY ("id", "organization_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "pavilion_map" ADD CONSTRAINT "FK_9985cc9d7d93e5c9ce906938fc2" FOREIGN KEY ("organization_id") REFERENCES "organization"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pavilion_map" DROP CONSTRAINT "FK_9985cc9d7d93e5c9ce906938fc2"`);
