...
export class init1682182417194 implements MigrationInterface {
    name = 'init1682182417194'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pavilion" ("id" SERIAL NOT NULL, "name" text NOT NULL, "square" numeric NOT NULL, "type" "public"."pavilion_type_enum" NOT NULL DEFAULT 'pavilion', "capacity" integer NOT NULL, "bedrooms" integer NOT NULL, "price" numeric NOT NULL, "main_img" text, "images" text array NOT NULL DEFAULT '{}', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "pavilion_map_id" integer, CONSTRAINT "PK_67a7906a4d5a18b600b49e677b0" PRIMARY KEY ("id"))`);
